...
Grava os dados dentro do index.html (padrão). Com uma saída .json, grava só os dados.
...
if HTML.endswith('.json'):
    json.dump(D, open(HTML, 'w', encoding='utf-8'), ensure_ascii=False)
    print('gravado', HTML); sys.exit()
